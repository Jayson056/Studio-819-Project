        ...
        <div class="container-fluid container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav align-items-lg-center">
                    ...
                    <li class="nav-item me-4"><a class="nav-link active" href="{{ url('/Studio-819-about') }}">About</a></li>
                    <li class="nav-item me-4"><a class="nav-link" href="services.php">Services</a></li>
                    <li class="nav-item me-4"><a class="nav-link" href="{{ url('/Studio-819-booking') }}">Booking</a></li>
                    <li class="nav-item me-4"><a class="nav-link" href="contact.php">Contact</a></li>
